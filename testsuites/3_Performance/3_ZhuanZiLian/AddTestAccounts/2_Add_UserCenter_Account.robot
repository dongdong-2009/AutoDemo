...
${data_file_name}    zhuanzilian_fake_account.csv
...
Set User Job
    ...
    Open Windows By Click Element     xpath=//*[@id="orgPosTree_2_a"]
    Click Element     xpath=//*[@id="orgPosAdd"]
    Select Checkbox     xpath=//*[@id="10000000231470"]/td[4]/input
    Select Checkbox     xpath=//*[@id="10000000231470"]/td[5]/input
