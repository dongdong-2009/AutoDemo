param([string]$testplan , [string]$caseDir,$include,$exclude,$outPutDir,$AppScanPath)
...
If ($exclude)
    {
        AppScanCMD exec -base_scan  <> -d $outPutDir\TempReport\RobotReport  $caseDir
     }
Else
    {
